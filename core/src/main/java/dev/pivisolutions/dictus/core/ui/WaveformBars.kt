 ...
 *   - Center 40% of bars: brand blue by default (DictusColors.Accent)
...
fun WaveformBars(
    ...
    innerColor: Color = DictusColors.Accent,
 ...
 */
internal fun barColor(index: Int, barCount: Int, outerBase: Color = Color.White, innerColor: Color = DictusColors.Accent): Color {
 ...
 * see [dev.pivisolutions.dictus.core.service.DictationState.Recording.energy].
...
fun WaveformBlob(
    ...
    edgeColor: Color = DictusColors.Accent,
) {
