...
import dev.avelissesolutions.avelisse.ime.di.AvelisseImeEntryPoint
import dev.avelissesolutions.avelisse.ime.suggestion.DictionaryEngine
import dev.avelissesolutions.avelisse.ime.suggestion.SuggestionEngine
import dev.avelissesolutions.avelisse.ime.ui.KeyboardScreen
import dev.avelissesolutions.avelisse.ime.ui.RecordingScreen
import dev.avelissesolutions.avelisse.ime.ui.TranscribingScreen
...
/**
 * Main IME service for Avelisse keyboard.
 *
 ...
 */
class AvelisseImeService : LifecycleInputMethodService() {

    companion object {
        /** Fully-qualified class name of DictationService in the app module. */
        private const val DICTATION_SERVICE_CLASS =
            "dev.avelissesolutions.avelisse.service.DictationService"
    }

    private val entryPoint: AvelisseImeEntryPoint by lazy {
        EntryPointAccessors.fromApplication(
            applicationContext,
            AvelisseImeEntryPoint::class.java,
        )
    }
    ...
    override fun onCreate() {
        super.onCreate()
        Timber.d("AvelisseImeService created")
    ...
    override fun KeyboardContent() {
        ...
        when (dictationState) {
            ...
            is DictationState.Recording -> {
                ...
                // Wrap in AvelisseTheme so MaterialTheme.colorScheme.background
                // resolves to the Avelisse brand colors instead of Material 3 defaults
