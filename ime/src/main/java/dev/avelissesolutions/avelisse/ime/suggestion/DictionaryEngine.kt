 ...
 * @param coroutineScope IME lifecycle scope (MainScope from AvelisseImeService).
...
class DictionaryEngine(
    ...
    override fun getSuggestions(input: String, maxResults: Int): List<String> {
        ...
        // Also include learned words NOT in the dictionary (user-typed words like "avelisse").
